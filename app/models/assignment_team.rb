class AssignmentTeam < Team
  ...
  # Factory Method implementation for AssignmentTeam.
  # Returns the class responsible for managing participants in assignments.
  ...
  # Recursively gathers all files (not directories) submitted by this team,
  # located within the team's submission directory and its subdirectories.
  # Returns an array of full file paths.
  # 
  # This method is defined in the team class because it operates on the
  # directory structure associated with a specific team's submissions.
  def files(directory)
  ...
  # gets the participant id of the currently logged in user, given their user id
  ...
  def assign_team_to_topic(signup_topic)
    ...
    TeamsUser.where(team_id: id).each do |team_user|
